...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="embed-metadata">
        <!-- this is how we add XMP embedded metadata to the file, which is required for a PDF-UA document.
            ...
            To see the results, go to File -> Properties when the file is opened in Adobe's Acrobat Reader
            -->
        <fo:declarations>
            <x:xmpmeta xmlns:x="adobe:ns:meta/">
                <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
                    <rdf:Description rdf:about="" xmlns:dc="http://purl.org/dc/elements/1.1/">
                        ...
                        <dc:title>
                            <xsl:value-of select="$finding-aid-title/normalize-space()"/>
                        </dc:title>
                    ...
                    <rdf:Description rdf:about=""
                        ...
                        <xmp:CreatorTool>Apache FOP 2.10</xmp:CreatorTool>
                    </rdf:Description>
                    <rdf:Description rdf:about=""
