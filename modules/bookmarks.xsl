...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="ead3:dsc" mode="bookmarks">
        <fo:bookmark internal-destination="dsc-contents">
            ...
            <xsl:apply-templates select="ead3:*[@level=$levels-to-include-in-bookmarks or @otherlevel=$otherlevels-to-include-in-bookmarks]" mode="bookmarks"/>
        </fo:bookmark>
    </xsl:template>
    ...
    <xsl:template match="ead3:*[matches(local-name(), '^c0|^c1') or local-name()='c']
        [@level=$levels-to-include-in-bookmarks or @otherlevel=$otherlevels-to-include-in-bookmarks]"
        ...
        <fo:bookmark internal-destination="{if (@id) then @id else generate-id(.)}">
            ...
            <xsl:apply-templates select="ead3:*[@level=$levels-to-include-in-bookmarks or @otherlevel=$otherlevels-to-include-in-bookmarks]" mode="#current"/>
        </fo:bookmark>
    </xsl:template>
